    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: THEME.background }}>
        ...
        <View style={styles.otpContainer}>
            ...
            <View style={styles.textContainer}>
                <Text style={[styles.otpTitle, {color: `${THEME.text}`}]}>Email Verification </Text>
                <Text style={[styles.otpText, {color: `${THEME.text}`}]}>We have sent code to your email address </Text>
            </View>
            ...
            <View style={styles.submitContainer}>
                <TouchableOpacity style={styles.btnVerify} activeOpacity={0.8} onPress={() => navigation.navigate('BottomNavigator')}>  
                    ...
                    <Text style={[styles.txtVerify, {color: `${COLORS.white}`}]}>Verify Email</Text>
                </TouchableOpacity>
            </View>
